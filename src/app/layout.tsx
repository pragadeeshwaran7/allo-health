      ...
      <body className="font-sans min-h-screen bg-[#030712] text-gray-100 antialiased selection:bg-indigo-500/30 overflow-x-hidden relative">
        ...
        <Providers>
          <div className="flex flex-col min-h-screen w-full items-center relative z-10">
            <header className="sticky top-0 z-50 w-full border-b border-white/5 bg-[#030712]/80 backdrop-blur-xl flex justify-center">
              <div className="w-full max-w-4xl px-8 lg:px-12">
            ...
            <main className="w-full max-w-4xl px-8 py-12 lg:px-12 flex-1">
              {children}
            </main>
          </div>
        </Providers>
